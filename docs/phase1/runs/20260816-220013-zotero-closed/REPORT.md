...
- **Generated:** `2026-08-16T14:00:16+00:00`
- **Label:** `zotero-closed`
- **Source:** `/mnt/d/zotero/zotero.sqlite`
- **Analysis DB:** `/home/shuo/develop/Paperazzi/probe-output/20260816-220013-zotero-closed/zotero_snapshot.sqlite`
...
- Size: `133656576` bytes
- mtime (UTC): `2026-08-16T13:58:09+00:00`
...
| itemTypes | 40 |
| itemData | 35970 |
| itemDataValues | 20823 |
| fields | 123 |
| fieldsCombined | 123 |
| creators | 7621 |
| itemCreators | 12522 |
| creatorTypes | 37 |
| itemAttachments | 2630 |
| collections | 121 |
| collectionItems | 3120 |
| tags | 727 |
| itemTags | 3326 |
| deletedItems | 51 |
| libraries | 2 |
...
| --- | --- | --- | --- | --- | --- |
| 5712 | UHLLBSJQ | preprint | Bridging the Gap Between Molecules and Materials in Quantum Chemistry with Localized Active Spaces | Daniel King [author]; Bhavnesh Jangid [author]; Matthew Hermes [author]; Laura Gagliardi [author] | 2026-08-15 07:09:19 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 5714 | 6AZ63FBU | 0 | application/pdf | storage:King 等 - 2024 - Bridging the Gap Between Molecules and Materials in Quantum Chemistry with Localized Active Spaces.pdf | zotero-storage | False |
| 5713 | 2NAE2YMV | 0 | application/pdf | storage:41467_2025_65846_MOESM1_ESM.pdf | zotero-storage | False |
